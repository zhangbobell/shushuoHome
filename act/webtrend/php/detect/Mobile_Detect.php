 ...
 * =====================
 *
 * Motto: "Every business should have a m detection script to detect m readers"
 *
 * Mobile_Detect is a lightweight PHP class for detecting m devices (including tablets).
 * It uses the User-Agent string combined with specific HTTP headers to detect the m environment.
 *
 ...
 *              Google Code:  http://code.google.com/p/php-m-detect/
...
class Mobile_Detect
{
    ...
    protected static $phoneDevices = array(
       ...
       'iMobile'        => 'i-m (IQ|i-STYLE|idea|ZAA|Hitz)',
        // Added simvalley m just for fun. They have some interesting devices.
        // @ref: http://www.simvalley.fr/telephonie---gps-_22_telephonie-mobile_telephones_.html
        'SimValley'     => '\b(SP-80|XT-930|SX-340|XT-930|SX-310|SP-360|SP60|SPT-800|SP-120|SPT-800|SP-140|SPX-5|SPX-8|SP-100|SPX-8|SPX-12)\b',
        // @Tapatalk is a m app; @ref: http://support.tapatalk.com/threads/smf-2-0-2-os-and-browser-detection-plugin-and-tapatalk.15565/#post-79039
    ...
    protected static $tabletDevices = array(
        'iPad'              => 'iPad|iPad.*Mobile', // @todo: check for m friendly emails topic.
        ...
        // Only the Surface tablets with Windows RT are considered m.
        ...
        // @note: Avoid detecting 'PLAYSTATION 3' as m.
        ...
        // @ref: http://www.allwinnertech.com/en/apply/m.html
        ...
        // i-m http://product.i-mobilephone.com/Mobile_Device
        'iMobileTablet'        => 'i-m i-note',
        ...
        // Tecno Mobile (only tablet) - http://www.tecno-m.com/index.php/product?filterby=smart&list_order=all&page=1
    ...
    /**
     * List of m User Agents.
     *
     * @var array
     */
    protected static $browsers = array(
        // @reference: https://developers.google.com/chrome/m/docs/user-agent
    ...
    protected static $utilities = array(
        // Experimental. When a m device wants to switch to 'Desktop Mode'.
        // @ref: http://scottcate.com/technology/windows-phone-8-ie10-desktop-or-m/
    ...
    protected static $uaHttpHeaders = array(
        ...
        // Vodafone specific header: http://www.seoprinciple.com/m-web-community-still-angry-at-vodafone/24/
    ...
    /**
     * Method gets the m detection rules. This method is used for the magic methods $detect->is*().
     *
     * @deprecated since version 2.6.9
     *
    ...
    /**
     * Method gets the m detection rules + utilities.
     * The reason this is separate is because utilities rules
     * don't necessary imply m. This method is used inside
    ...
    /**
     * Retrieve the list of m operating systems.
     *
     * @return array The list of m operating systems.
     */
    ...
    /**
     * Check the HTTP headers for signs of m.
     * This is the fastest m check possible; it's used
    ...
    /**
     * Check if the device is m.
     * Returns true if any type of m device detected, including special ones
     * @param null $userAgent deprecated
    ...
    /**
     * Retrieve the m grading, using self::MOBILE_GRADE_* constants.
     *
